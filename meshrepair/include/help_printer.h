...
print_help(const char* program_name)
{
    ...
    help << "\n"
         ...
         << "  --step-debug           Dump per-partition triangulate/refine/fair PLYs (trace only)\n"
         ...
         << "  --remove-thin-bridges <n> Remove narrow boundary-edge bridges within n face hops (disabled by default)\n"
         << "  --thin-bridge-min-boundary-sep <n> Boundary-edge separation guard for thin bridges (default: auto)\n"
